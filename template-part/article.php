<article class="latest-post article post-id">
    <div class="article-top">
        <div class="article-cat">
            <span class="cat-name">News</span>
        </div>
        <div class="article-features-img">
    ...
    <div class="article-details">
        ...
        <h2 class="article-title">What Is The Best Time To Buy A Home?</h2>
        <div class="article-excerpt">
            <p>Elementum curabitur vitae nunc sed velit dignissim sodales ut eu. Porta non pulvinar neque laoreet. Tincidunt lobortis feugiat vivamus at </p>
        </div>
    </div>
</article>